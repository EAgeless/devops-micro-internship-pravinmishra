...
![Virtual Network overview](screenshots/Wk-07-Ass-5-scrn-1.png)

---

#### Screenshot 2 — Public and private NSG inbound rules showing ports 80, 22, and restricted 3306 access

![Public and private NSG inbound rules](screenshots/Wk-07-Ass-5-scrn-2.png)

---

#### Screenshot 3 — Public IP and Network Interface association for the Virtual Machine

![Public IP and Network Interface](screenshots/Wk-07-Ass-5-scrn-3.png)
...
![Virtual Machine overview](screenshots/Wk-07-Ass-5-scrn-4.png)

---

#### Screenshot 5 — Terminal showing successful software installation or installed-version checks

![Terminal showing successful](screenshots/Wk-07-Ass-5-scrn-5.png)
...
![MySQL Flexible Server overview](screenshots/Wk-07-Ass-5-scrn-9.png)

---

#### Screenshot 10 — Networking configuration showing the private subnet and restricted access

![Networking configuration](screenshots/Wk-07-Ass-5-scrn-10.png)

---

#### Screenshot 11 — MySQL Client output showing the EpicBook database or imported tables (no password visible)

![MySQL Client output showing the EpicBook](screenshots/Wk-07-Ass-5-scrn-11.png)
...
![Browser showing the EpicBook application](screenshots/Wk-07-Ass-5-scrn-12.png)

---

#### Screenshot 13 — Proof of a successful database-backed action (viewing products, adding to cart, or placing an order)

![Proof of a successful database-backed](screenshots/Wk-07-Ass-5-scrn-13.png)

### Capture the terminal showing the epicbook process with the status online in: pm2 list

![pm2 list](screenshots/Wk-07-Ass-5-scrn-last.png)

---

#### Public IP URL

http://134.112.129.239/
