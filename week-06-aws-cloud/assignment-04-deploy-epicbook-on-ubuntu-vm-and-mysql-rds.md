...
![VPC details showing CIDR 10.0.0.0/16](screenshots/WK-06-Ass-4-scrn-1.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![Subnets list showing both subnets](screenshots/Wk-06-Ass-4-scrn-2.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Route table showing 0.0.0.0/0](screenshots/Wk-06-Ass-4-scrn-3.png)
...
![EC2 security-group](screenshots/Wk-06-Ass-4-scrn-4.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![RDS security-group](screenshots/Wk-06-Ass-4-scrn-5.png)
...
![EC2 instance summary](screenshots/Wk-06-Ass-4-scrn-6.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Terminal showing a successful SSH login](screenshots/Wk-06-Ass-4-scrn-7.png)
...
![Output of `node -v` and `npm -v`](screenshots/Wk-06-Ass-4-scrn-8.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Output of `systemctl status nginx`](screenshots/Wk-06-Ass-4-scrn-9.png)

---

#### Screenshot 10 — Output of `mysql --version`

![Output of `mysql --version`](screenshots/Wk-06-Ass-4-scrn-10.png)
...
![RDS instance summary](screenshots/Wk-06-Ass-4-scrn-11.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![Connectivity & security section](screenshots/Wk-06-Ass-4-scrn-12.png)
...
![Terminal showing successful `SHOW TABLES](screenshots/Wk-06-Ass-4-scrn-13.png)
...
![Terminal showing the repository cloned](screenshots/Wk-06-Ass-4-scrn-14.png)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![Terminal showing the backend running](screenshots/Wk-06-Ass-4-scrn-15.png)

---

#### Screenshot 16 — `curl` output proving the backend responds; a 200, 301, or 404 response is acceptable if the service responds

![`curl` output proving the backend responds](screenshots/Wk-06-Ass-4-scrn-16.png)
...
![`nginx -t` success output](screenshots/Wk-06-Ass-4-scrn-17.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Nginx configuration snippet](screenshots/Wk-06-Ass-4-scrn-18.png)
...
![Browser showing the EpicBook application](screenshots/Wk-06-Ass-4-scrn-19.png)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint, such as `curl http://<EC2_PUBLIC_IP>/api/...`

![Terminal showing a successful API call](screenshots/Wk-06-Ass-4-scrn-20.png)

---

#### Screenshot 21 — Terminal showing the successful database connectivity test using `SELECT 1;` or similar

![Terminal showing the successful database](screenshots/Wk-06-Ass-4-scrn-21.png)
