...
![`.claude` folder structure visible in VS Code Explorer](screenshots/Ass-06-scrn-1.PNG)
...
![`user-prompt-guard.sh` open in VS Code](screenshots/Ass-06-scrn-2.PNG)
...
![`pre-tool-guard.sh` open in VS Code](screenshots/Ass-06-scrn-3.PNG)
...
![`post-tool-logger.sh` open in VS Code](screenshots/Ass-06-scrn-4.PNG)
...
![`settings.json` open in VS Code](screenshots/Ass-06-scrn-5.PNG)
...
![UserPromptSubmit hook](screenshots/Ass-06-scrn-6.PNG)
