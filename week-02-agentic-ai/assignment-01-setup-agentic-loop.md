...
![Screenshot 1 — Terminal showing `claude --version`](screenshots/ASS-01-Scrn-1.PNG)

---

#### Screenshot 2 — Claude Code authenticated and showing the terminal prompt (your name visible)

![Screenshot 2 — Claude Code authenticated](screenshots/Ass-01-Scrn-2.PNG)
...
![VS Code with the project open, file tree visible showing](screenshots/Ass-01-Scrn-3.PNG)
...
![Claude's response to the first question](screenshots/Ass-01-Scrn-4.PNG)

---

#### Screenshot 5 — Claude's response to the second question, showing it ran a command and reported the line count

![Claude's response to the second question](screenshots/Ass-01-scrn-5.PNG)
