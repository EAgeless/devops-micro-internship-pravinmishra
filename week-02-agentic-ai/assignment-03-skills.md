...
![VS Code sidebar showing `.claude/skills/` folder](screenshots/Ass-03-scrn-1.PNG)
...
![`.claude/skills/scaffold-terraform/` open in VS Code](screenshots/Ass-03-scrn-2.PNG)

---

#### Screenshot 3 — Screenshot 3 — `tf-plan/SKILL.md` frontmatter showing `allowed-tools: Bash, Read, Grep` (no Write) and `disable-model-invocation: true`

![`tf-plan/SKILL.md` frontmatter](screenshots/Ass-03-scrn-3.PNG)
...
![Claude's response showing the scaffold complete](screenshots/Ass-03-scrn-4.PNG)

---

#### Screenshot 5 — VS Code sidebar showing the `terraform/` folder with all generated files inside

![VS Code sidebar showing the `terraform/` folder](screenshots/Ass-03-scrn-5.PNG)
...
![Claude's `/tf-plan` response](screenshots/Ass-03-scrn-6.PNG)
