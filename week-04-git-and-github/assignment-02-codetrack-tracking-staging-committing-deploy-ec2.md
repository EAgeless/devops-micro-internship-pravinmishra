...
![Output of `pwd` showing you're inside `CodeTrack`](screenshots/Wk-4-Ass-2-scrn-1.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![Output of `git status`](screenshots/Wk-4-Ass-2-scrn-2.png)
...
![Output of `ls` showing `index.html`](screenshots/WK-4-Ass-2-scrn-3.png)
...
![Your editor showing the contents of `index.html`](screenshots/Wk-4-Ass-2-scrn-4.png)
...
![Output of `git status`](screenshots/Wk-4-Ass-2-scrn-5.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![Output of `git status`](screenshots/Wk-4-Ass-2-scrn-6.png)
...
![Output of `git commit`](screenshots/Wk-4-Ass-2-scrn-7.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![Output of `git log --oneline`](screenshots/Wk-4-Ass-2-scrn-8.png)
...
![Browser showing the updated page](screenshots/Wk-4-Ass-2-scrn-9.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![Output of `git status` showing `index.html`](screenshots/Wk-4-Ass-2-scrn-10.png)

---

#### Screenshot 11 — Output of `git commit`

![Output of `git commit`](screenshots/Wk-4-Ass-2-scrn-11.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![Output of `git log --oneline`](screenshots/Wk-4-Ass-2-scrn-12.png)
...
![Output of `systemctl status nginx --no-pager`](screenshots/Wk-4-Ass-2-scrn-13.png)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![Output of `curl -I http://localhost`](screenshots/Wk-4-Ass-2-scrn-14.png)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![Browser showing the CodeTrack site loaded](screenshots/Wk-4-Ass-2-scrn-15.png)
...
![LinkedIn post](screenshots/Wk-4-Ass-2-LinkedInPost.png)
