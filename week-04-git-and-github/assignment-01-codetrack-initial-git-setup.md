...
![Output of `git init` inside `CodeTrack`](screenshots/Wk-4-Ass-1-scrn-1.png)

---

#### Screenshot 2 — Output of `ls -a` showing the `.git` folder

![Output of `ls -a` showing the `.git` folder](screenshots/Wk-4-Ass-1-scrn-2.png)
...
The .git folder is the hidden folder that turns a normal directory into a Git repository. It stores the project history, branches, commits, staging info, and other metadata Git needs to track changes.
It matters because:

Without .git, Git cannot track versions or history.

It lets you stage changes, commit them, and move between past versions.

It also keeps branch and remote information, so Git knows where your project has been and where it should go next.
...
![Output of `git config --local --list`](screenshots/WK-4-Ass-1-Scrn-3.png)
...
![Output of `git config --global --list`](screenshots/WK-4-Ass-1-scrn-4.png)
