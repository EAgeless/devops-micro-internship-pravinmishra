...
![Output of `node -v && npm -v`](screenshots/Wk-3-Ass-2-scrn-1.png)
...
![Output of `systemctl status nginx --no-pager`](screenshots/Wk-3-Ass-2-scrn-2.png)
...
![Output of `ls` inside the `my-react-app`](screenshots/Wk-3-Ass-2-scrn-3.png)
...
![`nano App.js` open showing your full name and date filled in](screenshots/Wk-3-Ass-2-scrn-4.png)
...
![Output of `ls` inside `my-react-app`](screenshots/Wk-3-Ass-2-scrn-5.png)
...
![Output of `ls /var/www/html/`](screenshots/Wk-3-Ass-2-scrn-6.png)
...
![Output of `systemctl is-active nginx` showing `active`](screenshots/Wk-3-Ass-2-scrn-7.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Output of `cat /etc/nginx/sites-available/default`](screenshots/Wk-3-Ass-2-scrn-8.png)
...
![Output of `curl ifconfig.me`](screenshots/Wk-3-Ass-2-scrn-9.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Browser showing the deployed React app](screenshots/Wk-3-Ass-2-scrn-10.png)
...
![LinkedIn post](screenshots/Wk-3-Ass-2-LinkedIn.png)
