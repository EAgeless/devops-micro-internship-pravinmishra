...
![Project confirmation](screenshots/Wk-05-Ass-2-scrn-1.png)
...
![Backlog showing the Epic panel](screenshots/Wk-05-Ass-2-scrn-2.png)
...
![Backlog showing the Epic](screenshots/Wk-05-Ass-2-scrn-3.png)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![One opened Story showing its Story point estimate](screenshots/Wk-05-Ass-2-scrn-4.png)
...
![S2 showing all four Sub-tasks](screenshots/Wk-05-Ass-2-scrn-5.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![S4 showing all four Sub-tasks](screenshots/Wk-05-Ass-2-scrn-6.png)
...
![Backlog or Story details](screenshots/Wk-05-Ass-2-scrn-7a.png)
![Backlog or Story details](screenshots/Wk-05-Ass-2-scrn-7b.png)
...
![Sprint 1 before starting](screenshots/Wk-05-Ass-2-scrn-8.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Active Sprint board](screenshots/Wk-05-Ass-2-scrn-9.png)
...
![Filter for label = frontend](screenshots/Wk-05-Ass-2-scrn-10.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![Filter for label = devops](screenshots/Wk-05-Ass-2-scrn-11.png)
...
![Burndown Chart page opened for Sprint 1](screenshots/Wk-05-Ass-2-scrn-12.png)
