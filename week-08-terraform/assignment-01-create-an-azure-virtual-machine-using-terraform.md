...
![Terminal showing successful `terraform version`](screenshots/Wk-08-Ass-1-scrn-1.png)

---

#### Screenshot 2 — Terminal showing successful `az version` output

![Terminal showing successful `az version`](screenshots/Wk-08-Ass-1-scrn-2.png)

---

#### Screenshot 3 — VS Code Extensions panel showing the HashiCorp Terraform extension installed and enabled

![the HashiCorp Terraform extension installed](screenshots/Wk-08-Ass-1-scrn-3.png)
...
![AzureRM provider configuration](screenshots/Wk-08-Ass-1-scrn-4.png)
...
![VS Code showing the Linux virtual machine](screenshots/Wk-08-Ass-1-scrn-5.png)
...
![successful `terraform init` output](screenshots/Wk-08-Ass-1-scrn-6.png)
...
![Terraform plan summary](screenshots/Wk-08-Ass-1-scrn-7.png)

![Terraform plan summary](screenshots/Wk-08-Ass-1-scrn-7b.png)

---

#### Screenshot 8 — Terraform apply output showing successful completion

![Terraform apply output](screenshots/WK-08-Ass-1-scrn-8.png)

---

#### Screenshot 9 — Terraform output showing the public IP address of the VM

![Terraform output showing the public IP](screenshots/Wk-08-Ass-1-scrn-9.png)

### Question

VM Public IP Address: ["74.235.6.72"]
...
![showing the deployed VM name and `VM running`](screenshots/Wk-08-Ass-1-scrn-10.png)
...
![successful `terraform destroy`](screenshots/Wk-08-Ass-1-scrn-11.png)
